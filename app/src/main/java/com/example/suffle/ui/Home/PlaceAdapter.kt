...
class PlaceAdapter (private val context: Context, private val clickListener: PlaceViewHolder.onClickListener): RecyclerView.Adapter<PlaceViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaceViewHolder {
        ...
        return PlaceViewHolder(view, clickListener)
    }
...
class PlaceViewHolder(itemview: View, val clickListener: onClickListener) : RecyclerView.ViewHolder(itemview){
